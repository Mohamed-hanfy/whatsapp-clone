...
public class ChatService {
    ...
    public String creatChat(String senderId, String receiverId) {
        Optional<Chat> exitingChat = chatRepository.fundChatByReceiverAndSender(senderId,receiverId);
        ...
        User receiver = userRepository.findByPublicId(receiverId).orElseThrow(()->new EntityNotFoundException("User "+receiverId+" not found"));
